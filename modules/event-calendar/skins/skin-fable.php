...
class Skin_Fable extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Fable', 'avator-widget-pack' );
	}

    public function render_header() {
		$settings = $this->parent->get_settings_for_display();
		
		$id       = 'avt-event-' . $this->parent->get_id();
		...
		$this->parent->add_render_attribute( 'carousel', 'class', ['avt-event-calendar', 'avt-event-carousel-skin-fable'] );

		if ('arrows' == $settings['navigation']) {
			$this->parent->add_render_attribute( 'carousel', 'class', 'avt-arrows-align-'. $settings['arrows_position'] );
			
		}
		if ('dots' == $settings['navigation']) {
			$this->parent->add_render_attribute( 'carousel', 'class', 'avt-dots-align-'. $settings['dots_position'] );
		}
		if ('both' == $settings['navigation']) {
			$this->parent->add_render_attribute( 'carousel', 'class', 'avt-arrows-dots-align-'. $settings['both_position'] );
		}
