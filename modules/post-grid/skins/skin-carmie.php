...
class Skin_Carmie extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Carmie', 'avator-widget-pack' );
	}
	...
	public function render() {
		...
		?> 
		<div id="avt-post-grid-<?php echo esc_attr($id); ?>" class="avt-post-grid avt-post-grid-skin-carmie">
		            ...
		            <div <?php echo $this->parent->get_render_attribute_string( 'post-grid-item' ); ?>>
		                <div class="avt-post-grid-item avt-transition-toggle avt-position-relative">
							...
							<div class="avt-custom-overlay avt-position-cover"></div>
					  		...
					  		<div class="avt-post-grid-desc avt-position-bottom-left">
