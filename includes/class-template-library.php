 ...
 */
class Widget_Pack_Template_Source extends Source_Base {
	...
	public function get_title() {
		return __( 'Widget Pack Templates', 'avator-widget-pack' );
	}
	 ...
	 *
	 * Retrieve remote templates from Widget Pack servers.
	 *
	 * @access public
	 *
	...
	public function get_items( $args = [] ) {
		...
		$template_server = Widget_Pack_Template_Manager::$template_server;
		$api_route       = Widget_Pack_Template_Manager::$api_route;
	 ...
	 *
	 * Retrieve the data of a single remote template from Widget Pack servers.
	 *
	 * @access public
	 *
