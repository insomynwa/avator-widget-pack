...
function avator_widget_pack_fail_load() {
	...
	if ( _is_elementor_installed() ) {
		...
		$admin_message = '<p>' . esc_html__( 'Ops! Avator Widget Pack not working because you need to activate the Elementor plugin first.', 'avator-widget-pack' ) . '</p>';
		...
		$admin_message = '<p>' . esc_html__( 'Ops! Avator Widget Pack not working because you need to install the Elementor plugin', 'avator-widget-pack' ) . '</p>';
